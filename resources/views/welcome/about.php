...
<body>
  ...
  <header class="cs_site_header cs_style_1 cs_type_3 cs_sticky_header cs_heading_font">
      ...
      <div class="container-fluid">
        <div class="cs_main_header_in">
          ...
          <div class="cs_main_header_right">
            ...
            <a href="/login" class="cs_btn cs_style_1 cs_fs_18 cs_semibold cs_accent_bg  cs_radius_100"><span class="cs_btn_text">Login</span></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="cs_casestudy cs_style_1 position-relative">
    ...
    <div class="container">
      <div class="cs_section_heading cs_style_1 cs_type_1">
        ...
        <div class="cs_section_heading_right mb-0">We follow a specialized approach focused on improving the quality of life for individuals facing serious illnesses by addressing their physical and emotional needs</div>
      </div>
          ...
          <div class="cs_slider_wrapper">
            ...
            <div class="cs_slide">
              <div class="cs_card cs_style_1 cs_radius_10">
                ...
                <div class="cs_card_bio">
                  <p class="cs_card_subtitle cs_fs_14 cs_heading_color">Holistic Care</p>
                  <h3 class="cs_card_title cs_fs_24 cs_bold">
                    <a href="case-studies-details.html">Physical, emotional, and psychological support</a>
                  </h3>
            ...
            <div class="cs_slide">
              <div class="cs_card cs_style_1 cs_radius_10">
                ...
                <div class="cs_card_bio">
                  <p class="cs_card_subtitle cs_fs_14 cs_heading_color">Curative Treatment</p>
                  <h3 class="cs_card_title cs_fs_24 cs_bold">
                    <a href="case-studies-details.html">Comprehensive medical support</a></h3>
            ...
            <div class="cs_slide">
              <div class="cs_card cs_style_1 cs_radius_10">
                ...
                <div class="cs_card_bio">
                  <p class="cs_card_subtitle cs_fs_14 cs_heading_color">Comfort-enhancing tools</p>
                  <h3 class="cs_card_title cs_fs_24 cs_bold">
                    <a href="case-studies-details.html">Enhance patient comfort at home</a>
                  </h3>
        ...
        <div class="cs_footer_col">
          <div class="cs_footer_widget">
            <div class="cs_footer_text_widget">
              ...
              <p>Aging with dignity, supported with love.</p>
            </div>
