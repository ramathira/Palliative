...
<body>
  ...
  <!-- End Header Section -->
  <!-- Start Hero Section -->
  <section class="cs_hero cs_style_1 cs_bg_filed position-relative" data-src="assets/img/back.jpg">
  ...
  <section class="cs_department cs_style_1">
    ...
    <div class="container">
      <div class="cs_section_heading cs_style_1 cs_text_center wow fadeInUp" data-wow-duration="0.9s" data-wow-delay="0.25s">
        <p class="cs_section_subtitle cs_accent_color cs_fs_18 cs_semibold cs_heading_font">Our FHC</p>
        ...
        <div class="col-xl-4 col-md-6">
          <a href="department-details.html" class="cs_iconbox cs_style_1 cs_radius_10 position-relative w-100">
            <div class="cs_iconbox_header">
              ...
              <h3 class="cs_iconbox_title cs_fs_32 cs_bold mb-0">Advanced Care Planning</h3>
            </div>
        ...
        <div class="col-xl-4 col-md-6">
          <a href="department-details.html" class="cs_iconbox cs_style_1 cs_radius_10 position-relative w-100">
            <div class="cs_iconbox_header">
              ...
              <h3 class="cs_iconbox_title cs_fs_32 cs_bold mb-0">Hospice Care</h3>
            </div>
            <div class="cs_iconbox_shape position-absolute"></div>
          </a>
        </div>
        <div class="col-xl-4 col-md-6">
          <a href="department-details.html" class="cs_iconbox cs_style_1 cs_radius_10 position-relative w-100">
            <div class="cs_iconbox_header">
              ...
              <h3 class="cs_iconbox_title cs_fs_32 cs_bold mb-0">Comfort Care</h3>
            </div>
            <div class="cs_iconbox_shape position-absolute"></div>
          </a>
        </div>
        <div class="col-xl-4 col-md-6">
          <a href="department-details.html" class="cs_iconbox cs_style_1 cs_radius_10 position-relative w-100">
            <div class="cs_iconbox_header">
              ...
              <h3 class="cs_iconbox_title cs_fs_32 cs_bold mb-0">End-of-Life Care</h3>
            </div>
            <div class="cs_iconbox_shape position-absolute"></div>
          </a>
        </div>
        <div class="col-xl-4 col-md-6">
          <a href="department-details.html" class="cs_iconbox cs_style_1 cs_radius_10 position-relative w-100">
            <div class="cs_iconbox_header">
              ...
              <h3 class="cs_iconbox_title cs_fs_32 cs_bold mb-0">Grief Counseling</h3>
            </div>
            <div class="cs_iconbox_shape position-absolute"></div>
          </a>
        </div>
        <div class="col-xl-4 col-md-6">
          <a href="department-details.html" class="cs_iconbox cs_style_1 cs_radius_10 position-relative w-100">
            <div class="cs_iconbox_header">
              ...
              <h3 class="cs_iconbox_title cs_fs_32 cs_bold mb-0">Pain Management</h3>
            </div>
            <div class="cs_iconbox_shape position-absolute"></div>
          </a>
        </div>
          ...
          <div class="cs_iconbox_wrapper cs_style_2">
            <div class="cs_iconbox cs_style_2 wow fadeInUp" data-wow-duration="0.9s" data-wow-delay="0.25s">
              ...
              <div class="cs_iconbox_text">
                ...
                <p class="cs_iconbox_subtitle cs_white_color">Compassionate Care, Timeless Support: Ensuring Health and Dignity for Every Stage of Life. </p>
