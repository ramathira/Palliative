                    ...
                    <div class="p-7">
                        ...
                        <div class="mt-5 block flex-col pt-5 first:mt-0 first:pt-0 sm:flex xl:flex-row xl:items-center">
                            ...
                            <div class="mt-3 w-full flex-1 xl:mt-0">
                                ...
                                <div class="flex flex-col items-center md:flex-row">
                                    <x-base.form-check class="mr-4 xl:mr-14 xl:w-80">
                                        <span> a) രോഗിക്ക് വിശപ്പുണ്ടോ? </span>
                                    </x-base.form-check>
                                    <x-base.form-check class="mr-4">
                                ...
                                <div class="flex flex-col items-center md:flex-row">
                                    <x-base.form-check class="mr-4 xl:mr-14 xl:w-80">
                                        <span> b) രോഗിയെ നിവർത്തിയിരുത്തിയാണോ ആഹാരം കൊടുക്കുന്നത്? </span>
                                    </x-base.form-check>
                                    <x-base.form-check class="mr-4">
                                ...
                                <div class="flex flex-col items-center md:flex-row">
                                    <x-base.form-check class="mr-4 xl:mr-14 xl:w-80">
                                        <span> c) ഭക്ഷണ നിയന്ത്രണങ്ങൾക്കായി ഡോക്ടറിന്റെ നിർദ്ദേശങ്ങൾ ശ്രദ്ധിച്ച് സമീകൃതാഹാരം നൽകാറുണ്ടോ?         </span>
                                    </x-base.form-check>
                                    <x-base.form-check class="mr-4">
                                ...
                                <div class="flex flex-col items-center md:flex-row">
                                    <x-base.form-check class="mr-4 xl:mr-14 xl:w-80">
                                        <span> d) രോഗിക്ക് ഡോക്ടറിന്റെ നിർദ്ദേശത്തിനനുസൃതമായി ദ്രാവകങ്ങൾ നൽകുന്നുണ്ടോ? </span>
                                    </x-base.form-check>
                                    <x-base.form-check class="mr-4">
                                ...
                                <div class="flex flex-col items-center md:flex-row">
                                    <x-base.form-check class="mr-4 xl:mr-14 xl:w-80">
                                        <span> e) രോഗിക്ക് മന്ദഗതിയിൽ ഭക്ഷണം നൽകേണ്ടുന്നതും ചെറിയ ഉരുളകളിൽ ഭക്ഷണം നൽകുകയും വിഴുങ്ങുന്നതിന് മുമ്പ് ചവയ്ക്കാൻ സമയം അനുവദിക്കുകയും ചെയ്യണമെന്ന് പരിചാരകർക്ക് അറിവുണ്ടോ? </span>
                                    </x-base.form-check>
                                    <x-base.form-check class="mr-4">
                                ...
                                <div class="flex flex-col items-center md:flex-row">
                                    <x-base.form-check class="mr-4 xl:mr-14 xl:w-80">
                                        <span> f) കിടക്കുമ്പോൾ രോഗിക്ക് ഭക്ഷണം നൽകരുതെന്ന് പരിചാരകർക്ക് അറിയാമോ?</span>
                                    </x-base.form-check>
                                    <x-base.form-check class="mr-4">
                    ...
                    <div class="p-7">
                        ...
                        <div class="mt-5 block flex-col pt-5 first:mt-0 first:pt-0 sm:flex xl:flex-row xl:items-center">
                            ...
                            <div class="mt-3 w-full flex-1 xl:mt-0">
                                <div class="flex flex-col items-center md:flex-row">
                                    <x-base.form-check class="mr-4">
                                        <input type="radio" id="checkbox-switch-1" name="volunteer_visit" value="1" >
                                        <x-base.form-check.label for="checkbox-switch-1">
                                            ഉണ്ട്
                                        </x-base.form-check.label>
                                    </x-base.form-check>
                                    <x-base.form-check class="mr-4">
                                        <input type="radio" id="checkbox-switch-2" name="volunteer_visit" value="2" >
                                        <x-base.form-check.label for="checkbox-switch-2">
                                            ഇല്ല
                                        </x-base.form-check.label>
                                    </x-base.form-check>
                        ...
                        <div class="mt-5 block flex-col pt-5 first:mt-0 first:pt-0 sm:flex xl:flex-row xl:items-center">
                            ...
                            <div class="mt-3 w-full flex-1 xl:mt-0">
                                <div class="flex flex-col items-center md:flex-row">
                                    <x-base.form-check class="mr-4">
                                        <input type="radio" id="checkbox-switch-1" name="rehabilitation_program" value="1" >
                                        <x-base.form-check.label for="checkbox-switch-1">
                                            ഉണ്ട്
                                        </x-base.form-check.label>
                                    </x-base.form-check>
                                    <x-base.form-check class="mr-4">
                                        <input type="radio" id="checkbox-switch-2" name="rehabilitation_program" value="2" >
                                        <x-base.form-check.label for="checkbox-switch-2">
                                            ഇല്ല
                                        </x-base.form-check.label>
                                    </x-base.form-check>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            jQuery(document).ready(function () {
               ...
               jQuery('#jphnCheckbox').on('change', function () {
                ...
                /*function handlePhyIllChange(event) {
                    if (event.target.value === '1') {
                        ...
                        // Hide the illness details section
                        illnessDetails.style.display = 'none';
                        // Clear all values in the difficulty[], duration[], and period[] fields
                        ...
                        difficultyInputs.forEach(input => input.value = '');
                        durationInputs.forEach(select => select.value = '');
                        periodInputs.forEach(select => select.value = '');
                    }
                }
                */
                // Attach the event listener to each radio button
                /*phyIllRadios.forEach(radio => {
                    radio.addEventListener('change', handlePhyIllChange);
                });
                */
                ...
                const csrfToken = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
                 try {
                    ...
                    if (responseData.success === false) {
                        ...
                        if (responseData.visited_id) {
                            formData.visited_id = responseData.visited_id;
                        }
