        ...
        <div class="col-span-12">
            <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                ...
                <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                    <a href="{{ route('ward_members.member_add') }}">
                    <x-base.button
                    ...
                    <div class="overflow-auto xl:overflow-visible">
                        ...
                        <x-base.table class="border-b border-slate-200/60">
                           ...
                           Status
                            ...
                            <x-base.table.tbody>
                                @foreach ($ward_members as $ward_member)
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3.5">
                                                    <a
                                                        ...
                                                        href=""
                                                    > 
                                                        {{  ($ward_member->status==1)? "Active":"Inactive"  }}
                                                    </a>
                                        ...
                                        <x-base.table.td class="relative border-dashed py-4 dark:bg-darkmode-600">
                                            <div class="flex items-center justify-center">
                                                <x-base.menu class="h-5">
                                                    ...
                                                    <x-base.menu.items class="w-40">
                                                        <x-base.menu.item :href="route('ward_members.member_edit', $ward_member->id)">
                                                            <x-base.lucide
                                                                class="mr-2 h-4 w-4"
                                                                icon="CheckSquare"
                                                            />
