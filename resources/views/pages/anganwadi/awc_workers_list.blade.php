        ...
        <div class="col-span-12">
            <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                ...
                <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                    <a href="{{ route('anganwadi.awc_worker_add') }}">
                    <x-base.button
                    ...
                    <div class="overflow-auto xl:overflow-visible">
                        ...
                        <x-base.table class="border-b border-slate-200/60">
                           ...
                           Status
                            ...
                            <x-base.table.tbody>
                                @foreach ($awc_workers as $awc_worker)
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3.5">
                                                    <a
                                                        ...
                                                        href=""
                                                    > 
                                                        {{  ($awc_worker->status==1)? "Active":"Inactive"  }}
                                                    </a>
                                        ...
                                        <x-base.table.td class="relative border-dashed py-4 dark:bg-darkmode-600">
                                            <div class="flex items-center justify-center">
                                                <x-base.menu class="h-5">
                                                    ...
                                                    <x-base.menu.items class="w-40">
                                                        <x-base.menu.item :href="route('anganwadi.awc_worker_list', $awc_worker->id)">
                                                            <x-base.lucide
                                                                class="mr-2 h-4 w-4"
                                                                icon="CheckSquare"
                                                            />
