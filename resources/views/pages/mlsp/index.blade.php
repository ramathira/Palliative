...
@section('subhead')
    <title>Mid Level Service Providers</title>
@endsection
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3.5">
                                                    <a
                                                        ...
                                                        href=""
                                                    >
                                                    {{  optional($mlsp->subcentre)->sub_centre ?? '' }}
                                                    </a>
                                            ...
                                            <div class="flex items-center justify-center">
                                                <x-base.menu class="h-5">
                                                    ...
                                                    <x-base.menu.items class="w-40">
                                                        <x-base.menu.item :href="route('anganwadi.edit', $mlsp->id)">
                                                            <x-base.lucide
                                                                class="mr-2 h-4 w-4"
                                                                icon="CheckSquare"
                                                            />
