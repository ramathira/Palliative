                ...
                <div class="box box--stacked flex flex-col p-5">
                    <div class="grid grid-cols-4 gap-5">
                        <div
                            ...
                            <div class="mt-1.5 text-2xl font-medium">0</div>
                        ...
                        <div
                            class="box col-span-4 rounded-[0.6rem] border border-dashed border-slate-300/80 p-5 shadow-sm md:col-span-2 xl:col-span-1">
                            <div class="text-base text-slate-500">Asha Workers</div>
                        ...
                        <div
                            class="box col-span-4 rounded-[0.6rem] border border-dashed border-slate-300/80 p-5 shadow-sm md:col-span-2 xl:col-span-1">
                            <div class="text-base text-slate-500">JPHN</div>
                            <div class="font-mediumm mt-1.5 text-2xl">0</div>
                            <div class="absolute inset-y-0 right-0 mr-5 flex flex-col justify-center">
                                <div
                                    class="flex items-center rounded-full border border-success/10 bg-success/10 py-[2px] pl-[7px] pr-1 text-xs font-medium text-success">
                ...
                <div class="box box--stacked flex flex-col">
                    ...
                    <div class="overflow-auto xl:overflow-visible">
                        <x-base.table class="border-b border-slate-200/60">
                            ...
                            <x-base.table.tbody>
                                @foreach ($users_list->take(10) as $user)
                                            ...
                                            <div class="flex items-center">
                                                <div class="image-fit zoom-in h-9 w-9">
                                                    <x-base.tippy
                                                       ...
                                                       src="{{ Vite::asset('resources/images/users/man_passport.png') }}"
                                                        alt="User Photo"
                                                        as="img"
                                                        content="{{ $user['name'] }}"
                                                    />
